    ...
    const startPress = (e) => {
      ...
      pressTimer = setTimeout(() => {
        if (isPressing) {
          ...
          if (logoTextEl) {
            const originalText = localStorage.getItem('neon_planner_app_title') || '�÷���';
            logoTextEl.textContent = state.device === 'pc' ? 'PC ��� ��ȯ' : '�ڵ��� ��� ��ȯ';
            setTimeout(() => {
               logoTextEl.textContent = localStorage.getItem('neon_planner_app_title') || '�÷���';
            }, 1500);
          }
        }
      }, 700);
